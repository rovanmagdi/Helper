  ...
  return (
    <Container sx={{
      ...
      <Stack sx={{ textAlign: "center", gap: 8 }}>
        ...
        ></Box>
        <Typography variant="h4" sx={{ fontWeight: 'bold' }}>who are we?</Typography>
        <Typography variant="h5" sx={{ fontWeight: 'bold' }}> What is your Helper ?</Typography>
      ...
      <Typography sx={{ lineHeight: 2, pt: 2 }}>
        Helper allows you to request maintenance and care services for your home from the best service professionals in your area, to choose the most suitable one to serve you based on an evaluation system and reviews for each service professional, an immediate reservation system, and a guarantee on services, at the best prices and offers.
      </Typography>
      ...
      <Box component="img" src={serviceImg} sx={{ position: "absolute", right: 50, width: "13%" }} />
      <Typography sx={{ lineHeight: 2, pb: 3 }}>
        <Box component="ul" sx={{ width: "90%" }}>
          <Box component="li">
            The best service professionals in your city to choose the most suitable one to serve you based on an evaluation and review system for each service provider.
          </Box>
          <Box component="li">
            Awesome prices and permanent offers.
          </Box>
          <Box component="li">
          ...
          <Box>
            ...
            Flexible and easy instant booking system. Choose the time that suits you and preach what serves you.
          </Box>
        </Box>
      </Typography>
    </Container>
